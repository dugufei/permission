...
public class RationaleDialogFragment extends DialogFragment {
  ...
  public static RationaleDialogFragment newInstance(
      ...
      ArrayList<PermissionRationaleBody> permsNecessary,@NonNull ArrayList<PermissionRationaleBody> permsNonNecessary) {
    ...
    RationaleDialogConfig config = new RationaleDialogConfig(
        positiveButton, negativeButton, body,requestCode, permsNecessary,permsNonNecessary);
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    // Create an Dialog
    return config.createNewDialog(getActivity(),config.body);
  }
